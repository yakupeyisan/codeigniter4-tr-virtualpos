...
class NestPayProvider extends VirtualPosBase
{
    ...
    {
        // NestPay'de status sorgulama için özel endpoint gerekebilir
        // Bu bankaya göre değişiklik gösterebilir
        throw new PaymentException('Status sorgulama bu provider için desteklenmiyor');
    }
